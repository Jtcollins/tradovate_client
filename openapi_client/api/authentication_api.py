    ...
    def __init__(self, api_client=None):
        ...
        def __access_token_request(
            ...
            **kwargs
            ...
            >>> thread = api.access_token_request(access_token_request, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['access_token_request'] = \
                access_token_request
            return self.call_with_http_info(**kwargs)

        self.access_token_request = _Endpoint(
            settings={
                'response_type': (AccessTokenResponse,),
                'auth': [],
                'endpoint_path': '/auth/accesstokenrequest',
                'operation_id': 'access_token_request',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__access_token_request
        )
        ...
        def __o_auth_token(
            ...
            **kwargs
            ...
            >>> thread = api.o_auth_token(o_auth_token, async_req=True)
            >>> result = thread.get()
        ...
        self.o_auth_token = _Endpoint(
            settings={
                'response_type': (OAuthTokenResponse,),
                'auth': [],
                'endpoint_path': '/auth/oauthtoken',
                'operation_id': 'o_auth_token',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__o_auth_token
        )

        def __renew_access_token(
            self,
            **kwargs
        ):
        ...
        self.renew_access_token = _Endpoint(
            settings={
                'response_type': (AccessTokenResponse,),
                'auth': [
                    'bearer_access_token'
                ],
                'endpoint_path': '/auth/renewaccesstoken',
