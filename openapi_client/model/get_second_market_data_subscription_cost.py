...
class GetSecondMarketDataSubscriptionCost(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, year, month, *args, **kwargs):  # noqa: E501
        """GetSecondMarketDataSubscriptionCost - a model defined in OpenAPI
