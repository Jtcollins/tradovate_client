...
class CashBalance(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, timestamp, trade_date, currency_id, amount, *args, **kwargs):  # noqa: E501
        """CashBalance - a model defined in OpenAPI
