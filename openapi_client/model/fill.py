...
class Fill(ModelNormal):
    ...
    attribute_map = {
        ...
        'finally_paired': 'finallyPaired',  # noqa: E501
        'id': 'id',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, order_id, contract_id, timestamp, trade_date, action, qty, price, active, finally_paired, *args, **kwargs):  # noqa: E501
