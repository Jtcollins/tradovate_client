...
class CheckReplaySessionResponse(ModelNormal):
    ...
    attribute_map = {
        'check_status': 'checkStatus',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, check_status, *args, **kwargs):  # noqa: E501
        """CheckReplaySessionResponse - a model defined in OpenAPI
