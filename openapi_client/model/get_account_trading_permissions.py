...
class GetAccountTradingPermissions(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, *args, **kwargs):  # noqa: E501
        """GetAccountTradingPermissions - a model defined in OpenAPI
