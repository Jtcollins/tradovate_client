...
class StartOrderStrategy(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, symbol, order_strategy_type_id, action, *args, **kwargs):  # noqa: E501
        """StartOrderStrategy - a model defined in OpenAPI
