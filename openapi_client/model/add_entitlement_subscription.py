...
class AddEntitlementSubscription(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, entitlement_id, *args, **kwargs):  # noqa: E501
        """AddEntitlementSubscription - a model defined in OpenAPI
