...
class AddTradovateSubscription(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, tradovate_subscription_plan_id, *args, **kwargs):  # noqa: E501
        """AddTradovateSubscription - a model defined in OpenAPI
